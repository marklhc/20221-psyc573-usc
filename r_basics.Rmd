...
```{r programming-pic, echo = FALSE, fig.cap = "Figure from http://www.phdcomics.com/comics/archive/phd031714s.gif", out.extra = "class=external"}
knitr::include_graphics("http://www.phdcomics.com/comics/archive/phd031714s.gif")
```
