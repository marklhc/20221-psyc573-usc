...
```{stan stan1, code = readLines(here("slides/stan", "hierarchical_bin.stan")), echo = TRUE, eval = FALSE, output.var = "hbern_mod"}
```
...
tt_fit <- stan(
    file = here("slides/stan", "hierarchical_bin.stan"),
...
```{stan stan2, code = readLines(here("slides/stan", "hierarchical_norm.stan")), echo = TRUE, eval = FALSE, output.var = "hnorm_mod"}
```
...
```{r fit, results = "hide"}
fit <- stan(
    file = here("slides/stan", "hierarchical_norm.stan"),
    data = schools_dat,
