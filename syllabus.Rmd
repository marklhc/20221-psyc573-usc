...
- [R](https://cloud.r-project.org/) and [RStudio](https://rstudio.com/products/rstudio/download/) are needed to complete the course assignments. It is highly recommended that students update to the latest versions of both software (R 4.1.0, RStudio 2021.09.0, or above). We will briefly discuss how to set up R and RStudio in Week 1.
...
|                |       Activities       |                                  |                 Dates                  |
+================+========================+==================================+========================================+
| Week 1\        | - Overview of          | - Gigerenzer (2004)              | - Exercise: R Markdown                 |
| Jan 11 & 13    | Bayesian Statistics    | - [Kruschke ch. 2][1]            | - HW 1                                 |
| (Remote)       | - R programming I      | - Supplemental: [James ch. 1][2] |                                        |
|                | - R Markdown           | - [Markdown Quick Reference][3]  |                                        |
+----------------+------------------------+----------------------------------+----------------------------------------+
| Week 2\        | - Probability          | - Kruschke ch. 4                 | - Exercise: Probability                |
| Jan 18 & 20    | - R programming II     | - Wickham & Grolemund            | - HW 2                                 |
|                |                        | ch. [7][4], [19][5]              |                                        |
+----------------+------------------------+----------------------------------+----------------------------------------+
| Week 3\        | - Bayes Theorem        | - Kruschke ch. 5                 | - Exercise: Screening test example     |
| Jan 25 & 27    |                        |                                  |                                        |
+----------------+------------------------+----------------------------------+----------------------------------------+
| Week 4\        | - One Parameter Models | - Kruschke ch. 6                 | - Exercise: Graphical check            |
| Feb 1 & 3      | - Posterior predictive | - [Gabry et al. (2019)][6]       | - HW 3                                 |
|                | checks                 |                                  |                                        |
+----------------+------------------------+----------------------------------+----------------------------------------+
...
| Feb 15 & 17    |                        | - [MCMC Interactive Gallery][7]  | - HW 5                                 |
+----------------+------------------------+----------------------------------+----------------------------------------+
...
[1]: https://drive.google.com/file/d/1tr7XpIVf04S44o5ZploxJcd37Fg1GygV/view
[2]: https://jim-stone.staff.shef.ac.uk/BookBayes2012/bookbayesch01.pdf
[3]: https://web.mit.edu/r/current/RStudio/resources/markdown_help.html
[4]: https://r4ds.had.co.nz/exploratory-data-analysis.html
[5]: https://r4ds.had.co.nz/functions.html
[6]: https://rss.onlinelibrary.wiley.com/doi/full/10.1111/rssa.12378
